...
class AliyunClient:
    ...
    # 图片翻译
    def translate_image(self, target_url, source_language, target_language):
...
if __name__ == '__main__':
    ...
    url = 'http://tristana-oss.oss-cn-shanghai.aliyuncs.com/2024/10/26/test_pic1.jpg?OSSAccessKeyId=LTAI5tMS3r8LEYPeTe1m6sQQ&Expires=1729940930&Signature=hbgdc4iywzkSvUvJo4uBzL1MEu8%3D'
