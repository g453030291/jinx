...
class Task(SQLModel, table=True):
    ...
    creator_id: int = Field(default=0, description="创建者ID")
    creator_name: Optional[str] = Field(default="", max_length=56, description="创建者名称")
    ...
    deleted_at: datetime = Field(default=datetime(1970, 1, 1, 8, 0, 0), description="删除时间")
    deleted: bool = Field(default=False, description="是否删除")
